...
public class CornMonsterModel<T extends Entity> extends EntityModel<T> {
	...
	private final ModelPart rotated_root;

	public CornMonsterModel(ModelPart root) {
		this.rotated_root = root.getChild("rotated_root");
		this.bone4 = rotated_root.getChild("bone4");
		this.bone = rotated_root.getChild("bone");
		this.bone3 = rotated_root.getChild("bone3");
		this.bone2 = rotated_root.getChild("bone2");
		this.bb_main = rotated_root.getChild("bb_main");
	}
	...
	public static LayerDefinition createBodyLayer() {
		...
		.texOffs(62, 16).addBox(-2.0F, -4.0F, -1.0F, 3.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(7.0F, -6.0F, -3.0F));

		PartDefinition bone = rotated_root.addOrReplaceChild("bone", CubeListBuilder.create().texOffs(45, 60).addBox(2.0F, 2.0F, -8.0F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
		...
		.texOffs(35, 62).addBox(2.0F, 3.0F, 1.0F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(3.0F, -11.0F, 3.0F));
		...
		PartDefinition bone3 = rotated_root.addOrReplaceChild("bone3", CubeListBuilder.create().texOffs(8, 65).addBox(8.0F, -2.0F, 16.0F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		...
		.texOffs(20, 70).addBox(9.0F, -3.0F, 16.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(-3.0F, -9.0F, -9.0F));

		PartDefinition bone2 = rotated_root.addOrReplaceChild("bone2", CubeListBuilder.create().texOffs(8, 65).addBox(8.0F, -2.0F, 16.0F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(56, 66).addBox(4.0F, -3.0F, 16.0F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(42, 52).addBox(5.0F, -1.0F, 16.0F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(66, 57).addBox(6.0F, 2.0F, 16.0F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(68, 50).addBox(7.0F, 4.0F, 16.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
		...
		.texOffs(60, 64).addBox(3.0F, -8.0F, 16.0F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(70, 18).addBox(10.0F, -1.0F, 16.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(20, 70).addBox(9.0F, -3.0F, 16.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(-3.0F, -9.0F, -24.0F));

		PartDefinition bb_main = rotated_root.addOrReplaceChild("bb_main", CubeListBuilder.create().texOffs(26, 35).addBox(-3.0F, -4.0F, -4.0F, 7.0F, 1.0F, 8.0F, new CubeDeformation(0.0F))
		...
		.texOffs(68, 11).addBox(0.0F, -2.0F, 1.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
		rotated_root.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
	}
}